			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ฟาตีอะ ดาฮิง" class="rounded-circle shadow" width="140" height="140" src="assets/img/f.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>ฟาตีฮะ ดาฮิง</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010035</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/profile.php?id=100023972179660" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @fateehah.dahing</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="อัรวา ดอแม" class="rounded-circle shadow" width="140" height="140" src="assets/img/w.jpg" />
						<h5 class="pt-4 mb-3">ผู้ช่วยพัฒนาระบบ</h5>
						<h2>อัรวา ดอแม</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010040</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/arwa.domae" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @arwa.domae</a></p>
					</div>
					<div class="col-lg-4 pb-4">
